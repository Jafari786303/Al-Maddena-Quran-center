...
function setupCourseFormUX() {
  ...
  const refresh = () => {
    const isQuranyath = mainCourseSelect.value === "quranyath";
    tajweedStageLabel.classList.toggle("hidden", !isQuranyath);
    tajweedStageSelect.required = isQuranyath;
    if (!isQuranyath) tajweedStageSelect.value = "";
  };
