...
const COURSE_TREE = {
  intro_holy_quran: { label: "Introduction to the Holy Quran (Quranyqath)", subs: ["Tajweed", "History of Revelation (Wahi)", "Compilation of the Quran", "Makki and Madani Surahs", "Tawheed (Oneness of Allah)", "Akhirah (Life Hereafter)"] },
  seerath: { label: "Seerath", subs: ["Introduction to Seerah", "Early Preaching of Islam", "Migration to Madinah", "Battle of Badr", "Conquest of Makkah", "Character of the Prophet ﷺ"] },
  ahkam: { label: "Ahkam", subs: ["Rules of Purification", "Rules of Salah", "Rules of Fasting", "Rules of Zakat", "Rules of Marriage", "Islamic Rulings for Daily Life"] },
  akhlaq: { label: "Akhlaq", subs: ["Truthfulness", "Patience and Tolerance", "Respect for Parents", "Forgiveness", "Controlling Anger", "Islamic Ethics in Daily Life"] }
};
const PDF_LINKS = {
...
function setupPublicPdfBrowser() {
  ...
  const refreshLink = () => {
    ...
    const url = PDF_LINKS[sub];
    publicPdfLink.innerHTML = url ? `<a href="${url}" target="_blank" rel="noopener">Open PDF for: ${sub}</a>` : "PDF not linked yet.";
  };
