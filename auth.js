...
const COURSE_TREE = {
  intro_holy_quran: { label: "Introduction to the Holy Quran (Quranyqath)", subs: [
  ...
  seerath: { label: "Seerath", subs: [
    "Introduction to Seerah","Arabia Before Islam","Family Background of Prophet Muhammad ﷺ","Birth of the Prophet ﷺ","Childhood and Upbringing","Youth of the Prophet ﷺ","Trade and Honesty","Marriage with Hazrat Khadijah (RA)","Cave Hira and Worship","First Revelation","Early Preaching of Islam","Persecution in Makkah","Migration to Abyssinia","Isra and Miraj","Pledges of Aqabah","Migration to Madinah","Construction of Masjid-e-Nabawi","Brotherhood in Madinah","Battle of Badr","Battle of Uhud","Battle of the Trench","Treaty of Hudaybiyyah","Conquest of Makkah","Farewell Sermon","Character of the Prophet ﷺ","Justice of the Prophet ﷺ","Kindness Towards Women","Love for Children","Passing of the herererer ﷺ"
  ] },
  ahkam: { label: "Ahkam", subs: [
...
const i18n = {
  en: { title: "Tajweed Center", heading: "Structured Islamic Learning for Mobile-First Students", auth: "Registration & Login", reg: "Registration Form", login: "Login" },
...
function setupPublicPdfBrowser() {
  ...
  const refreshLink = () => {
    ...
    publicPdfLink.innerHTML = `<a href="${url}" target="_blank" rel="noopener">Open PDF for: ${sub}</a>`;
  };
